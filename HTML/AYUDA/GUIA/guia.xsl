...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
		<head>
			<title>ESCUELA INFANTIL DUENDES SAN VICENTE DEL RASPEIG INGLÉS INFANTIL GUIA PARA PADRES</title>
		...
		<body>
			<div id="wrapper">
				...
				<div class = "margen3">
					<a target="_blank">
						<xsl:attribute name = "HREF">
							<xsl:value-of select = "pagina/pie/descarga/ruta"/>
						</xsl:attribute>
					
				
						<img>
							<xsl:attribute name = "src">
								<xsl:value-of select ="pagina/pie/descarga/imagen"/>
							</xsl:attribute>			
						</img>
