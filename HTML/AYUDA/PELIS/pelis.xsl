...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
		<head>
			<title>ESCUELA INFANTIL DUENDES SAN VICENTE DEL RASPEIG INGLÉS INFANTIL PELIS INFANTILES</title>
							...
							<xsl:for-each select ="pagina/cuerpo/fila">		
								<tr>
									<td width = "20%" align = "center">
										<img width = "140" height="160" valign = "top" align="middle" hspace="15" vspace="15" >
