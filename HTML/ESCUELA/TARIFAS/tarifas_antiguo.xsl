...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
		<head>
			<title>ESCUELA INFANTIL DUENDES SAN VICENTE DEL RASPEIG INGLÉS INFANTIL TARIFAS</title>
		...
		<body>
			<div id="wrapper">
				...
				<div id="main">					
					...
					<xsl:for-each select ="pagina/cuerpo/elem">
					...
					<p>
						<a> 
							<a target="_blank">
								...
								<img src = "../../../IMAGENES/images/untitled.png" alt = "escuela duendes facebook" width = "2%" heigth = "2%"/>
							</a>
						</a>	
