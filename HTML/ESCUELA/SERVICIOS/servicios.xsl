...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
		<head>
			<title>ESCUELA INFANTIL DUENDES SAN VICENTE DEL RASPEIG INGLÉS INFANTIL PSICÓLOGO COMEDOR MAÑANA TARDE </title>
		...
		<body>
			<div id="wrapper">
				...
				<div id="main">	
					...
					<table width = "100%" align = "center" Cellspacing = "15px">
						<xsl:for-each select ="pagina/cuerpo/fila">			
							<tr>
								<xsl:for-each select ="./serv">	
									<td width = "50%" align = "center">
										<div>
											<h4><font color ="black"><b><xsl:value-of select ="./texto"/></b></font></h4>
					...
					<xsl:for-each select ="pagina/cuerpo/serv">
						<xsl:variable name = "lista" select = "position()"/>
						<xsl:if test="$lista mod 2 != 0">
							<div class = "flota borde" width = "200px">
								<h4><font color = "black"><b><xsl:value-of select ="./texto"/></b></font></h4>
