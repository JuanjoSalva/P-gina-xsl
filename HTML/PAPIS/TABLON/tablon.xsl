...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
		<head>
			<title>ESCUELA INFANTIL DUENDES SAN VICENTE DEL RASPEIG INGLÉS INFANTIL YABLON ANUNCIOS</title>
		...
		<body>
			<div id="wrapper">
				...
				<div id="main">					
					...
					<!--div style = "margin-left: -1.95em"-->
						<!--table class = "Fondo_corcho" width = "100%" heigth = "100%"-->
						<table class = "Fondo_corcho">
